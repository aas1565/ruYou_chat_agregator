...
export const NAV_ITEMS = [
  { href: "/home", label: "Главная", icon: "home", implemented: false },
  { href: "/inbox", label: "Входящие", icon: "inbox", implemented: true },
  { href: "/clients", label: "Клиенты", icon: "users", implemented: true },
  { href: "/leads", label: "Заявки", icon: "clipboard", implemented: true },
  { href: "/appointments", label: "Записи", icon: "calendar", implemented: false },
  { href: "/deals", label: "Сделки / Продажи", icon: "briefcase", implemented: false },
  { href: "/analytics", label: "Аналитика", icon: "chart", implemented: false },
