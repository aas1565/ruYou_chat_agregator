...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-bg px-4">
      ...
      <div className="pointer-events-none absolute -bottom-28 -left-16 h-72 w-72 rounded-full bg-[#487abf]/20 blur-3xl" />
      <div className="relative w-full max-w-md rounded-[22px] border border-border bg-surface p-8 shadow-[var(--academy-panel-shadow)]">
        <p className="academy-eyebrow">Ruyou</p>
