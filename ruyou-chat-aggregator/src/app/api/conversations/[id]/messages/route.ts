...
import { createClientMessageForTesting, createOperatorMessage } from "@/lib/services/message.service";
...
export async function POST(request: Request, { params }: Params) {
  ...
  if (parsed.data.senderType === "CLIENT") {
    const detail = await createClientMessageForTesting({
      conversationId: id,
