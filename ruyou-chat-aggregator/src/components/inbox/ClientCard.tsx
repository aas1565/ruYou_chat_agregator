...
export function ClientCard({
  ...
  return (
    <div className="flex h-full flex-col overflow-y-auto bg-surface p-4 scrollbar-thin">
      <div>
        ...
        <div className="mt-2 flex flex-wrap gap-2">
          {channels.length === 0 ? (
            ...
            channels.map((channel) => (
              <span key={channel} className="inline-flex items-center gap-1 rounded-md bg-surface-3 px-2 py-1 text-xs">
      ...
      <div className="mt-6">
        ...
        {client.notes[0] ? (
          <p className="mt-2 text-sm leading-5 text-muted">{client.notes[0].text}</p>
        ) : (
